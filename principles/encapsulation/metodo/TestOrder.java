...
public class TestOrder {
	...
	public static void main(String[] args) {
		...
		////
		RefactorOrder orderR =new RefactorOrder("MX");//Instancia para orden que dado el país e impuestos
		// me regresa el total
		orderR.addItem(car2);//Pongo producto	
		
		System.out.println("(Refactor)Total a pagar en MX: "+orderR.getTotal());
		
		orderR.setCountry("JP");
		System.out.println("(Refactor)Total a pagar en JP: "+orderR.getTotal());
	}
